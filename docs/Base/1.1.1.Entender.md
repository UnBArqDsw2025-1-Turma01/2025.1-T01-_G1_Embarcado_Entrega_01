...
## Resumo 
Na organização das atividades da segunda-feira, seguimos a metodologia proposta no livro *[Sprint](../Base/1.2.1.Léxicos.md#sprint)*, de Jake Knapp. Esse primeiro dia foi dedicado a definir o [objetivo de longo prazo](../Base/1.2.1.Lexicos.md#objetivo-de-longo-prazo) do projeto, mapear o desafio e levantar [perguntas críticas](../Base/1.2.1.Léxicos.md#perguntas-críticas), permitindo que a equipe alinhasse expectativas e concentrasse esforços na parte mais importante do problema a ser resolvido durante a semana.
