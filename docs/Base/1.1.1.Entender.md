...
## Resumo 
Na organização das atividades da segunda-feira, seguimos a metodologia proposta no livro *[Sprint](/Base/1.2.1.Lexicos.md#sprint)*, de Jake Knapp. Esse primeiro dia foi dedicado a definir o [objetivo de longo prazo](/Base/1.2.1.Lexicos.md#objetivo-de-longo-prazo) do projeto, mapear o desafio e levantar [perguntas críticas](/Base/1.2.1.Lexicos.md#perguntas-críticas)
