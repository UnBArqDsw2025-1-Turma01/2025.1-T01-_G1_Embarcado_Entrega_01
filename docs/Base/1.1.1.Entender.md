...
[Sprint](#/Base/1.2.1.Lexicos.md#sprint)

## Resumo 
Na organização das atividades da segunda-feira, seguimos a metodologia proposta no livro *[Sprint](../Base/1.2.1.Lexicos.md?id=sprint#sprint)*, de Jake Knapp. Esse primeiro dia foi dedicado a definir o [objetivo de longo prazo](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/Base/1.2.1.Lexicos.md#objetivo-de-longo-prazo) do projeto, mapear o desafio e levantar [perguntas críticas]([perguntas críticas](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#perguntas-críticas)
), permitindo que a equipe alinhasse expectativas e concentrasse esforços na parte mais importante do problema a ser resolvido durante a semana.

## Início do Sprint CuideMe

O [Sprint](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#sprint) é uma metodologia intensiva de cinco dias, desenvolvida pelo Google Ventures, para resolver grandes problemas e testar ideias rapidamente. Ele ajuda a equipe a sair do campo das suposições e partir para soluções concretas, com foco, colaboração e validação com usuários reais.

No projeto **[CuideMe](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#cuideme)**, seguimos essa abordagem com pequenas adaptações para enfrentar o desafio de planejar e executar o desenvolvimento do projeto.

Como indicado no livro *Sprint*, de Jake Knapp, a segunda-feira é dedicada a **[entender](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#entender)** profundamente o desafio e **definir onde vamos concentrar os esforços da semana**. Abaixo, mostramos as etapas que realizamos seguindo essa estrutura.

## 🗓️ Segunda-feira no Sprint: Entender e Mapear o Problema

A segunda-feira é o primeiro dia do Sprint. O foco principal é **[entender](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#entender)** o desafio por completo e **definir onde concentrar os esforços da semana**.
...
> “Se tudo der certo, onde queremos estar daqui a 6 meses ou 1 ano?”
...
Cinco tipos de [especialistas](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#especialistas) que devem ser consultados:

### 1. Estratégia (ex: [Definidor](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#definidor))
...
- Criação de um mapa simples da [jornada do usuário](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#jornada-do-usuário).
...
1. Cada pessoa recebe 2 etiquetas (o [Definidor](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#definidor) recebe 4).
...
O [Definidor](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#definidor) escolhe:
...
Desenvolver um [sistema](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#sistema) de monitoramento de quedas para [idosos](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#idosos) ou pessoas com mobilidade reduzida, composto por um [dispositivo wearable](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#wearable) com sensores e uma [aplicação](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#aplicação) (app ou plataforma web) para [cuidadores](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#cuidador), promovendo segurança, autonomia e resposta rápida em situações críticas.
...
1. *Como poderíamos garantir a precisão da detecção de quedas usando sensores como acelerômetro e giroscópio?*

2. *Como poderíamos definir o melhor formato e local de uso para o wearable (pulso, cinto, colar etc.), considerando conforto e eficácia?*

3. *Como poderíamos criar um sistema de alerta eficaz e rápido para o cuidador (app, SMS, WhatsApp, ligação)?*

4. *Como poderíamos desenvolver uma interface compreensível para cuidadores com diferentes níveis de escolaridade?*

5. *Como poderíamos tornar o sistema acessível financeiramente para pessoas de baixa renda, sem comprometer a funcionalidade?*
...
**Primário:** [Idosos](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#idosos) e/ou pessoas com mobilidade reduzida, que vivem sozinhas ou passam longos períodos sem supervisão.  
**Secundário:** [Cuidadores](https://unbarqdsw2025-1-turma01.github.io/2025.1-T01-_G1_Embarcado_Entrega_01/#/Base/1.2.1.Lexicos.md#cuidador), familiares, enfermeiros e profissionais da saúde da atenção básica.
...
| 1.1    | 10/04/2025 | Inclusão da introdução baseada no livro *Sprint* e transição para execução prática do projeto  | [Altino Arthur](https://github.com/arthurrochamoreira)       | [Revisor](https://github.com/revisor) |
| 1.2    | 10/04/2025 | Adição de links para os termos do léxico no conteúdo do Sprint CuideMe – Dia 1 (Entender)      | [Altino Arthur](https://github.com/arthurrochamoreira)       | [Revisor](https://github.com/revisor) |
