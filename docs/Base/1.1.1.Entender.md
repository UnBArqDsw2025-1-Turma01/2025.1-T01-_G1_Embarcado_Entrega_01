...
## Resumo 
Na organização das atividades da segunda-feira, seguimos a metodologia proposta no livro *Sprint: O Método Usado no Google Para Testar e Aplicar Novas Ideias em Apenas Cinco Dias*, de Jake Knapp. Esse primeiro dia foi dedicado a definir o objetivo de longo prazo do projeto, mapear o desafio e levantar perguntas cruciais, permitindo que a equipe alinhasse expectativas e concentrasse esforços na parte mais importante do problema a ser resolvido durante a semana.

## Início do Sprint CuideMe

O Sprint é uma metodologia intensiva de cinco dias, desenvolvida pelo Google Ventures, para resolver grandes problemas e testar ideias rapidamente. Ele ajuda a equipe a sair do campo das suposições e partir para soluções concretas, com foco, colaboração e validação com usuários reais.

No projeto **CuideMe**, seguimos essa abordagem com pequenas adaptações para enfrentar o desafio de planejar e executar o desenvolvimento do projeto.

Como indicado no livro *Sprint*, de Jake Knapp, a segunda-feira é dedicada a **entender profundamente o desafio** e **definir onde vamos concentrar os esforços da semana**. Abaixo, mostramos as etapas que realizamos seguindo essa estrutura.

## 🗓️ Segunda-feira no Sprint: Entender e Mapear o Problema

A segunda-feira é o primeiro dia do Sprint. O foco principal é **entender o desafio por completo** e **definir onde concentrar os esforços da semana**.
...
Cinco tipos de especialistas que devem ser consultados:
...
- Criação de um mapa simples da **jornada do usuário**.
...
1. Cada pessoa recebe 2 etiquetas (o Definidor recebe 4).
