...
<img src="../assets/storyboard-software.jpg" alt="Storyboard do Software" width="1000px" />

---

## 🧓📡 Storyboard 2 – Interação com o Hardware do Sistema

<img src="../assets/storyboard-hardware.jpg" alt="Storyboard do Hardware" width="1000px" />

---

## 🧓📡 Storyboard 3 – Interação Social do sistema

<img src="../assets/storyboard-hardware2.png" alt="Storyboard do Hardware" width="1000px" />

---

## 🧓📡 Storyboard 4 – Interação Social do sistema

<img src="../assets/storyboard-hardware3.png" alt="Storyboard do Hardware" width="1000px" />
...
| `1.2`  | 11/04/2025 | Adição storyboard Interação Social do sistema e revisão | [Lara Giuliana](https://github.com/gravelylara) |  |
